...
var ForOfStatement = function (identifier, index, expression, body) {
...
ForOfStatement.prototype.compileExpression = function () {
  ...
  r2 = this.index ? this.index.toJavaScript() : scopes.reference();
  r3 = scopes.reference();
...
ForOfStatement.prototype.toJavaScript = function() {
