...
//// Transforms a preformated AST as nested arrays into a correctly indented string.
...
//  var body;
//  var identifiers = scopes.withScope(function () {
//    body = parseBody(ast);
//  });
...
//  scopes.withScope(function () { // we scope to skip method arguments
...
//    
//    case "splat":
//      scopes.pushIdentifier(ident = arg[1][1]);
...
////    } else if (!scopes.isDefined(expr[1])) {
...
//  
////  case "range":
//////    if (expr[2][0] === "const" && expr[3][0] === "const") {
////      var list = [];
////      for (var i = expr[2][1]; i < expr[3][1]; i++) {
////        list.push(i);
////      }
////      if (expr[1] === "...") {
////        list.pop();
...
////      rs.push("]");
//////    } else {
//////      var ref = scopes.reference();
//////      rs.push("var " + ref + " = [], __i;");
//////      rs.push("for (__i = " + parseExpression(expr[2]) + ", len = " + parseExpression(expr[3]) + ".length; __i < len; i++) {");
//////      rs.push(ref + ".push(__i);");
//////      rs.push("}");
//////    }
////    break;
//  
...
//  case "access":
//    if (expr[2][0] == "slice") {
//      var a = parseExpression(expr[1]);
//      var s = parseExpression(expr[2][2]);
//      var e = parseExpression(expr[2][3]);
//      if (expr[2][1] == "...") {
//        rs.push("Array.prototype.slice.call(" + a + ", " + s + ", " + e + ")");
//      } else {
//        rs.push("Array.prototype.slice.call(" + a + ", " + s + ", " + e + " + 1)");
//      }
//    } else {
