...
function BeginStatement(body, rescues, _ensure) {
    var self = this;
    self.body = body;
    self.rescues = rescues || [];
    self._ensure = _ensure;
}
BeginStatement.prototype.constructor = BeginStatement;
...
BeginStatement.prototype.compileRescues = function (rs) {
    var self = this;
    var __ref1, __ref2, _rescue, i, ref;
